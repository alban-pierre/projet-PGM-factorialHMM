...
The main idea here is to approximate the posterior distribution by a tractable distribution and make the assumption that the state variables are independent given the observations.
